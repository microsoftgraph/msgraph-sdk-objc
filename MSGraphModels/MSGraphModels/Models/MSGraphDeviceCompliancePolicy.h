...
@class MSGraphDeviceComplianceScheduledActionForRule, MSGraphDeviceComplianceDeviceStatus, MSGraphDeviceComplianceUserStatus, MSGraphDeviceComplianceDeviceOverview, MSGraphDeviceComplianceUserOverview, MSGraphSettingStateDeviceSummary, MSGraphDeviceCompliancePolicyAssignment; 
